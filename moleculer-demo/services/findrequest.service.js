...
module.exports = {
     ...
     */
    adapter: new MongooseAdapter("mongodb://localhost:27018/solicitud"),
        ...
        servicefind: {
			...
			async handler(ctx) {
                ...
                for( let i = 1; i <= contdb; i++) {
                    switch(i){
                        case 1:
                            const con01 = new MongooseAdapter("mongodb://27018:mexicomov/solicitud");
					        ...
					        return resp01;
                        case 2:
                            const con02 = new MongooseAdapter("mongodb://27019:costaricamov/solicitud");
					        ...
					        return resp02;
                        case 3:
                            const con03 = new MongooseAdapter("mongodb://27020:panamamov/solicitud");
					        ...
					        return resp03;
                        case 4:
                            const con04 = new MongooseAdapter("mongodb://27021:colombiamov/solicitud");
